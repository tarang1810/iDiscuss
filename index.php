...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <!-- <img src="https://source.unsplash.com/2400x700/?devloper,programming" class="d-block w-100" alt="..."> -->
        ...
        <div class="row my-4">
          ...
          // echo $row['category_name'];
            ...
            echo '<div class="col-md-4 my-2">
                ...
                <!-- <img src="https://source.unsplash.com/1600x900/?'.$cat .',coding" class="card-img-top" alt="image for category"> -->
